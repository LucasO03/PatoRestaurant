...
public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
{
    ...
    public DbSet<StatusReservation> StatusResarvations { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        List<StatusReservation> listStatusResarvation = new()
        {
            ...
            {
                Id = 1, Name = "Aguardando Confirmação"
            },
            new StatusReservation()
            {
                Id = 2, Name = "Reserva Confirmada"
            },
            new StatusReservation()
            {
                Id = 3, Name = "Reserva Cancelada"
            },
            new StatusReservation()
            {
                Id = 4, Name = "Reserva Reagendada"
            }

        };
        builder.Entity<StatusReservation>().HasData(listStatusResarvation);
        #endregion
