...
namespace PatoRestaurant.Controllers
{
    public class ReservationController : Controller
    {
        ...
        {
            ViewData["StatusReservationId"] = new SelectList(_context.StatusResarvations, "Id", "Name");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,ReservationDate,Phone,Guests,Email,CreatedDate,StatusReservationId")] Reservation reservation)
        {
            ...
            ViewData["StatusReservationId"] = new SelectList(_context.StatusResarvations, "Id", "Name", reservation.StatusReservationId);
            return View(reservation);
        }
